...
from .resnet_varients import seresnet50
...
def build_resnet(name="seresnet50", pretrained=True, num_selayers=4):
    # resnet = torchvision.models.resnet.__dict__[name](pretrained=pretrained)
    resnet = seresnet50(pretrained=pretrained, num_selayers=num_selayers, pretrained_strict=False)
    logger.info(resnet)
